        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="/assignment/save" method="POST">
                        <?= csrf_field(); ?>
                        <div class="row text-capitalize row-input">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('task_name')) ?
                                                                                'is-invalid' : ''; ?>" id="task_name" name="task_name" placeholder="Task Name" autofocus value="<?= old('task_name'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="point" name="point" placeholder="point" value="<?= old('point'); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
