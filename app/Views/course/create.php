                        ...
                        <div class="row text-capitalize row-input">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('course_name')) ?
                                                                                'is-invalid' : ''; ?>" id="course_name" name="course_name" placeholder="Course Name" autofocus value="<?= old('course_name'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="trainer_name" name="trainer_name" placeholder="Mentor Name" value="<?= old('trainer_name'); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="description" class="form-label">description</label>
                                    <textarea class="form-control" id="description" name="description" placeholder="description" rows="3" value="<?= old('description'); ?>"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="sampul" class="col-md-2 col-form-label">Cover</label>
